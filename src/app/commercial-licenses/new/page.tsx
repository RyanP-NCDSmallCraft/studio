...
import { CommercialLicenseForm } from "@/components/commercial-licenses/CommercialLicenseForm";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h1 className="text-3xl font-bold">New Commercial License</h1>
      </div>
      <CommercialLicenseForm mode="create" />
    </div>
  );
}
