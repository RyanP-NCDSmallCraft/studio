...
import { PlusCircle, Eye, Filter, Search, Contact, ArrowLeft, Loader2, AlertTriangle, MoreHorizontal, RefreshCw } from "lucide-react";
import { 
  DropdownMenu, 
  DropdownMenuTrigger, 
  DropdownMenuContent, 
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem asChild>
                            <Link href={`/operator-licenses/${lic.licenseApplicationId}`} className="cursor-pointer flex items-center">
                              <Eye className="mr-2 h-4 w-4" /> View Details
                            </Link>
                          </DropdownMenuItem>
                          {canAddNew && ["Approved", "Expired"].includes(lic.status) && (
                            <>
                              <DropdownMenuSeparator />
                              <DropdownMenuItem asChild>
                                <Link 
                                  href={`/operator-licenses/new?type=Renewal&previousLicenseNumber=${lic.assignedLicenseNumber || lic.licenseApplicationId}`} 
